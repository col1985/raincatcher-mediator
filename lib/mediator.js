...
Mediator.prototype.request = function(topic, parameters, options) {
  ...
  var timer = stats.time('mediator-request', {
    topic: topics,
    parameters: parameters
  });

  logger('medator-request: topics', topics);
  logger('medator-request: parameters', parameters);
  logger('medator-request: opts', options);
  ...
  logger('mediator-publish: args.length'+ args.length)
